...
Below we'll build our network. we'll implement the forward pass through the network. We'll also set the hyperparameters: the learning rate, the number of hidden units, and the number of training passes.
